...
-The the EC2 ip address may be blocked from sending email, if this is the case, please retry on another server with different ip address.
...
**About the Admin**
To access the abilities of the admin user, please create an account with all fields called admin (the email can be admin@something.com). As the admin, when you visit the products page, you can also choose to delete products and edit them. You can also view a list of all users (accessible via an added link in the navbar), where you can view and delete user records if you wish, or all of them at once. Orders are similar, you can view all orders via the Orders List link in the navbar, and perform a deletion of all records, or single records. As an admin, you can also add products to the store.

*** Custom Configurations ***
If you wish to use your own email to send purchase receipts, please goto /var/www/estore/application/controllers/order.php and /var/www/estore/config/email.php to edit the $config array with your email providers necessary protocol details and login information.